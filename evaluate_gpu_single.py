...
gallery_name = 'gallery_satellite'       # 无人机到卫星
query_name = 'query_drone'

# gallery_name = 'gallery_drone'     # 卫星到无人机
...
def sift_F(image_paths):
    ...
    # sift = cv.ORB_create()
    # sift = cv.xfeatures2d.SURF_create(400, upright=True, extended=False)
    features = []
...
CMC1, ap1 = rerank(query_feature, query_label, gallery_feature, gallery_label, query_sift_features, gallery_sift_features)
print('Rank@1:%.2f Rank@5:%.2f AP:%.2f' % (CMC1[0] * 100, CMC1[4] * 100, ap1 * 100))# Rank@10:%.2f , CMC1[9] * 100
